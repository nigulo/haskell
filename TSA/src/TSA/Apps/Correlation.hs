...
main = do
    ...
    findCorrelation defaultTaskEnv (createDataParams_ "dat1" [createSubDataParams_ (SD1 dat1)]) (createDataParams_ "dat2" [createSubDataParams_ (SD1 dat2)]) precision shifts "correlation"
    return ()
