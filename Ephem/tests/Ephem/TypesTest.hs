module Ephem.TypesTest (tests) where
...
tests :: TestTree
tests = testGroup "Types Tests"
    [ testCase "toDMS" test_toDMS
    , testCase "toDeg" test_toDeg
    , testCase "toRad" test_toRad
    , testCase "toSec" test_toSec
    , testCase "angleToHours" test_angleToHours
    , testCase "hoursToAngle" test_hoursToAngle
    , testCase "absAngle" test_absAngle
    , testCase "sgnAngle" test_sgnAngle
    , testCase "toHMS" test_toHMS
    , testCase "toHrs" test_toHrs
    , testCase "toValidYMD" test_toValidYMD
    , testCase "ymdToJD" test_ymdToJD
    , testCase "ymdToTropicalYears" test_ymdToTropicalYears
    , testCase "ymdToRJD" test_ymdToRJD
    , testCase "ymdToMJD" test_ymdToMJD
    , testCase "ymdToTJD" test_ymdToTJD
    , testCase "tropicalYearsToYMD" test_tropicalYearsToYMD
    , testCase "JDToYMD" test_JDToYMD
    , testCase "RJDToYMD" test_RJDToYMD
    , testCase "MJDToYMD" test_MJDToYMD
    , testCase "TJDToYMD" test_TJDToYMD
    , testCase "diffDays" test_diffDays
    , testCase "toLatitude" test_toLatitude
    , testCase "toLongitude" test_toLongitude
    ]

test_toDMS :: Assertion
test_toDMS = do
